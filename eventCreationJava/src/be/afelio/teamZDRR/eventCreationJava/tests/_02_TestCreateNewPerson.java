...
class _02_TestCreateNewPerson {

	@Test
	void testNotDuplicatePerson() {
		...
		actual.setName("Franquinet");
		actual.setFirstname("Delphine");
		actual.setEmail("delphine@nomail.be");
		actual.setPassword("1234");
		
		try {
			repository.createNewPerson(actual);
		}
		*/
	}
